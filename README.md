...
## Contenido
- Análisis Bitcoin en El Salvador.pdf (archivo con el trabajo final) disponible en el repositorio del proyecto.
## Principales temas
- Contexto previo a la adopción del Bitcoin en El Salvador.
- Economía de El Salvador.
- Impacto y resultados del Bitcoin a nivel socioeconómico.
- Conclusiones y aplicación del caso de estudio a la Argentina.
